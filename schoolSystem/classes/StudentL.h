...
public:
    ...
    bool passCheck(){
        ...
        Connection *conn = db.dbConnection();
        string selectQuery = "SELECT pass FROM tbl_student;";
        Statement *stmt = conn->createStatement();
    ...
    void showClas(){
        Connection *conn = db.dbConnection();
        string selectQuery = "SELECT tbl_class.name as ClassName FROM tbl_student JOIN mm_class_student ON mm_class_student.fk_student = ? JOIN tbl_class ON mm_class_student.fk_class = tbl_class.id;";
    ...
    void showLessons(){
        Connection *conn = db.dbConnection();
        string selectQuery = "SELECT tbl_lesson.name as LessonName FROM tbl_student JOIN mm_lesson_student ON mm_lesson_student.fk_student = ? JOIN tbl_lesson ON mm_lesson_student.fk_lesson = tbl_lesson.id;";
        PreparedStatement *pstmt = conn->prepareStatement(selectQuery);
